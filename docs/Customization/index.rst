...
autogenerated from the most recent version of the :py:mod:`meep_adjoint` source code,
but for starters here are some of the more useful options, categorized by the
sector of :py:mod:`meep_adjoint` behavior they affect:
...
For each configuration option, :py:mod:`meep_adjoint` consults
the following fixed sequence of 
    ...
    :2. Default Driver script
        ...
        The python script you write to drive your :py:mod:`meep_adjoint` study may optionally
        override
        custom defaults 
